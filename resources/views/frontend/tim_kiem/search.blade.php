    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="store" class="col-md-9">
                ...
                <div class="row">
                    <!-- product -->
                    @foreach($search_product as $key => $lp)
                    <div class="col-md-4">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h4 class="product-price">{{ $lp -> Price }}$</h4>
                                ...
                                <div class="product-btns">
                                    <button onclick="window.location.href = '{{ URL::to('/Details-Product/'.$lp-> Productid) }}'" 
                            ...
                            <div class="add-to-cart">
                                <input name="product_hidden_id" type="hidden" value="{{ $lp->Productid }}">
